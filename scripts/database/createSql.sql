...
-- -----------------------------------------------------
-- Placeholder table for view `online_judge`.`contest_rank`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `online_judge`.`contest_rank` (`id` INT);

-- -----------------------------------------------------
-- View `online_judge`.`contest_rank`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `online_judge`.`contest_rank`;
USE `online_judge`;
CREATE  OR REPLACE VIEW `contest_rank` AS
select * from submit
where contest_id='1';
