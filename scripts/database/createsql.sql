...
CREATE TABLE IF NOT EXISTS `online_judge`.`submits` (
  ...
  INDEX `fk_submits_languages1_idx` (`languages_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_submit_user1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_submits_languages1`
...
CREATE TABLE IF NOT EXISTS `online_judge`.`contests_support_languages` (
  `contests_id` INT UNSIGNED NOT NULL,
  `languages_id` INT NOT NULL,
  PRIMARY KEY (`contests_id`, `languages_id`),
  INDEX `fk_contests_support_languages_languages1_idx` (`languages_id` ASC) VISIBLE,
  INDEX `fk_contests_support_languages_contests1_idx` (`contests_id` ASC) VISIBLE,
