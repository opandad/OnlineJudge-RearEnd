...
初始化测试表用
*/
INSERT INTO `users` (`id`, `email`, `name`, `password`, `authority`, `user_info`) VALUES (1, "abc@qq.com", "abc", "abc", "user", NULL);
INSERT INTO `users` (`id`, `email`, `name`, `password`, `authority`, `user_info`) VALUES (2, "jsontest@qq.com", "json", "json", "json", '{
    "hello":"helloworld",
    "numb":1000,
    "nihao":"nihao"
}');
