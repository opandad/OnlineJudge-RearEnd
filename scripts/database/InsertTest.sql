...
INSERT INTO `problems` (`id`, `name`, `description`, `accept`, `fail`, `is_robot_problem`, `judgeer_info`) VALUES (2, "c++", NULL, 0, 0, false, NULL);
INSERT INTO `submits` (`id`, `submit_state`, `run_time`, `submit_time`, `problem_id`, `contest_id`, `user_id`, `language_id`) VALUES (1, "ac", 1000, "2021-01-08 12:00:00", 1, 1, 1, 1);
