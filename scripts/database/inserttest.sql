...
INSERT INTO `languages` (`id`, `language`) VALUES (1, "C++");
...
INSERT INTO `submits` (`id`, `submit_state`, `submit_time`, `problem_id`, `contest_id`, `user_id`, `submit_info`, `is_error`, `submit_code`) VALUES (1, "Accept", "2021-01-08 12:00:00", 1, 1, 1, "{}", false, "");
